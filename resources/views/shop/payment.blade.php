...
<div>
    <div class="g-pay-lst">
            ...
            <li>
                <a href="">
                    ...
                    <dl>
                        ...
                        <dd><em class="price">{{$v->buy_num}}</em>件/单价：<em>￥{{$v->self_price}}</em></dd>
                    </dl>
                </a>
            </li>
            @endforeach
        ...
        <p class="gray9">总需支付金额：<em class="orange"><i>￥</i>{{$priceNum}}</em></p>
    </div>
    ...
    <div class="other_pay marginB">
        ...
        <a href="javascript:;" class="wzf checked">
            <b class="z-set"></b>第三方支付<em class="orange fr"><span class="colorbbb">需要支付&nbsp;</span><b>￥</b>{{$priceNum}}</em>
        </a>
        <div class="net-pay">
    ...
    <div class="g-Total-bt">
        <dd><a id="btnPay" href="javascript:;" class="orangeBtn fr w_account" priceNum="{{$priceNum}}">立即支付</a></dd>
    </div>
    ...
    <div class="paywrapp" style="display: none">
        ...
        <span class="money">￥<i>{{$priceNum}}</i></span>
