...
<div class="m-block-header" id="div-header">
    ...
    <a href="javascript:;"  id="submits"  address_id="{{$arr->address_id}}" class="m-index-icon">保存</a>
</div>
<div class=""></div>
    ...
    <div class="addrcon">
        <ul>
            <li>
                ...
                <input type="text" id="address_name" placeholder="请填写真实姓名" style="height:30px;font-size: 18px" value="{{$arr->address_name}}">
            </li>
            <li>
                <font style="font-size: 18px">手机号码</font><em></em>
                <input type="number" id="address_tel" placeholder="请输入手机号" style="height:30px;font-size: 18px" value="{{$arr->address_tel}}">
            </li>
            <li>
                <font style="font-size: 18px">邮编</font><em></em>
                <input type="number" id="address_mail" placeholder="请输入邮编" style="height:30px;font-size: 18px" value="{{$arr->address_mail}}">
            </li>
            <li class="addr-detail">
                <font style="font-size: 18px">详细地址</font><em></em>
                <input type="text" placeholder="20个字以内" id="address_desc" style="height:30px;font-size: 18px" value="{{$arr->address_desc}}">
            </li>
        </ul>
        <div class="setnormal">
            <span><font style="font-size: 18px">设为默认地址</font></span>
            @if($arr->address_default==1)
            <input type="checkbox" id="address_default" lay-skin="switch" checked>
                @else
